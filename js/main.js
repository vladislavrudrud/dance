;(function () {
	...
	var tabs = function() {
		...
		// Auto adjust height
		$('.qbootstrap-tab-content-wrap').css('height', 0);
		var autoHeight = function() {

			setTimeout(function(){

				var tabContentWrap = $('.qbootstrap-tab-content-wrap'),
					tabHeight = $('.qbootstrap-tab-nav').outerHeight(),
		...
		// Click tab menu
		$('.qbootstrap-tab-nav a').on('click', function(event){
			...
			$('.qbootstrap-tab-nav li').removeClass('active');
